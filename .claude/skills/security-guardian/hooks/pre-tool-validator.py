#!/usr/bin/env python3
"""
Security Guardian - PreToolUse Hook
...
class PreToolValidator:
    ...
    def _format_block_message(self, findings: List[Tuple[str, str, int]],
        ...
        lines = [
            "",
            "=" * 60,
            f"🔴 SECURITY GUARDIAN - OPERATION BLOCKED ({severity})",
            "=" * 60,
            "",
            f"File: {file_path}",
            "",
        ...
        lines.extend([
            ...
            "  1. Add a comment: // security-guardian-ignore: PATTERN_ID",
...
def main():
    ...
    try:
        ...
        print(f"Security Guardian hook error: {e}", file=sys.stderr)
        sys.exit(1)
